  ...
  return (
    <>
      <Modal show={true} onHide={onHide}>
        ...
        <Modal.Body>
          <p> What do you need to do to sustain your daily life on Mars? Are you doing research or connecting with fellow Martians? This feature allows you to create, save, and delete your Martian tasks  </p>
        ...
        <Modal.Footer>
          <p>Learn more about life as a Martian at: <a href="https://en.wikipedia.org/wiki/Colonization_of_Mars#:~:text=Human%20survival%20on%20Mars%20would,matter%20of%20days%20without%20it."
            target="_blank" aria-label="Link to Wikipedia entry about Colonization of Mars Takes You to Another Website" rel="noopener noreferrer">Colonization of Mars</a></p>
